...
// @IBDEsigable: để update giao diện ở Main.storyboard. Có thay đổi nào ở đây là nó tự thay đổi giao diện luôn.
@IBDesignable
class PlusButton: UIButton {

  // Một cách khai báo biến trả về 1 giá trị, private để bên ngoài ko gọi được biến này. Không để được dấu "=" vì chưa có thuộc tính bounds
    ...
    //@IBInspectable, có cái này, thì biến này sẽ được thay đổi ở cột inspecter
    ...
    override func draw(_ rect: CGRect) {
        ...
        // so sánh chiều rộng và chiều cao button, lấy giá trị nhỏ hơn sau đó nhân với tỉ lệ
